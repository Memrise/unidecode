...
class TestUnidecode(unittest.TestCase):
    ...
    def test_specific(self):
        ...
        TESTS = [
            ...
            (u"Efﬁcient",
             "Efficient"),  # https://github.com/iki/unidecode/commit/4a1d4e0a7b5a11796dc701099556876e7a520065
            (u'příliš žluťoučký kůň pěl ďábelské ódy',
             'prilis zlutoucky kun pel dabelske ody'),

            (u'PŘÍLIŠ ŽLUŤOUČKÝ KŮŇ PĚL ĎÁBELSKÉ ÓDY',
             'PRILIS ZLUTOUCKY KUN PEL DABELSKE ODY'),  # Table that doesn't exist
            (u'\ua500',
    ...
    def test_wordpress_remove_accents(self):
        ...
        wp_remove_accents = {  # Decompositions for Latin-1 Supplement
                               ...
                               chr(200) + chr(154): 'T', chr(200) + chr(155): 't',  # Vowels with diacritic (Vietnamese)
                               # unmarked
                               chr(198) + chr(160): 'O', chr(198) + chr(161): 'o',
                               chr(198) + chr(175): 'U', chr(198) + chr(176): 'u',  # grave accent
                               ...
                               chr(225) + chr(187) + chr(178): 'Y', chr(225) + chr(187) + chr(179): 'y',  # hook
                               ...
                               chr(225) + chr(187) + chr(182): 'Y', chr(225) + chr(187) + chr(183): 'y',  # tilde
                               ...
                               chr(225) + chr(187) + chr(184): 'Y', chr(225) + chr(187) + chr(185): 'y',  # acute accent
                               chr(225) + chr(186) + chr(164): 'A', chr(225) + chr(186) + chr(165): 'a',
                               chr(225) + chr(186) + chr(174): 'A', chr(225) + chr(186) + chr(175): 'a',
                               chr(225) + chr(186) + chr(190): 'E', chr(225) + chr(186) + chr(191): 'e',
                               chr(225) + chr(187) + chr(144): 'O', chr(225) + chr(187) + chr(145): 'o',
                               chr(225) + chr(187) + chr(154): 'O', chr(225) + chr(187) + chr(155): 'o',
                               chr(225) + chr(187) + chr(168): 'U', chr(225) + chr(187) + chr(169): 'u',  # dot below
                               ...
                               chr(201) + chr(145): 'a',  # macron
                               chr(199) + chr(149): 'U', chr(199) + chr(150): 'u',  # acute accent
                               chr(199) + chr(151): 'U', chr(199) + chr(152): 'u',  # caron
                               chr(199) + chr(141): 'A', chr(199) + chr(142): 'a',
                               chr(199) + chr(143): 'I', chr(199) + chr(144): 'i',
                               chr(199) + chr(145): 'O', chr(199) + chr(146): 'o',
                               chr(199) + chr(147): 'U', chr(199) + chr(148): 'u',
                               chr(199) + chr(153): 'U', chr(199) + chr(154): 'u',  # grave accent
                               chr(199) + chr(155): 'U', chr(199) + chr(156): 'u',

                               chr(195) + chr(132): 'A',
                               chr(195) + chr(150): 'O',
                               chr(195) + chr(156): 'U',  # chr(195)+chr(159) : 's',
                               chr(195) + chr(164): 'a',
                               chr(195) + chr(182): 'o',
                               chr(195) + chr(188): 'u',  # Known differences:  #chr(195)+chr(158) : 'TH',
                               #chr(197)+chr(137) : 'N',  #chr(197)+chr(138) : 'n',  #chr(197)+chr(139) : 'N',
                               # Euro Sign  #chr(226)+chr(130)+chr(172) : 'E',  # GBP (Pound) Sign
                               #chr(194)+chr(163) : '',
        }
